...
const Home = () => {
    ...
    <div className='content-wrapper'>
        ...
        <p>I'm a student at Stanford interested in language education, web design, and machine learning. I have experience in <b className='special'>Python</b>, <b className='special'>C++</b>, <b className='special'>JavaScript</b>, and <b className='special'>TypeScript</b>, as well as the <b className='special'>Next.js, React,</b> and <b className='special'>Flask</b> frameworks. I am passionate in leveraging software engineering and machine learning to improve language education and several other fields.</p>
